                            ...
                            >
                                {
                                    Object.entries(trackLists)
                                        ...
                                        .map(([ trackListId, trackList ], index) => (
                                            ...
                                            >
                                                <div className='sized-content v-flex flex-center' style={{ gap: '10px' }}>
                                                    <div className='sized-content h-flex flex-center'>{trackListId}</div>
                                                    <div className='sized-content h-flex flex-center' style={{ gap: '10px' }}>
                                                        {
                                                            trackList.trackedItems == null ? null:
                                    ...
                                    com.showDialogUi({
                                        ...
                                        ok: (ev, text) => {
                                            ...
                                            if(trackLists[id] != null) { 
                                                ...
                                                com.showDialogUi({
                                                    title: 'A Track List with this name already exists! Overwrite?',
                                                    type: 'okcancel',
                                                    ok: () => {
                                                        addTrackList();
                                                    }
