            ...
            if(!("Items" in filters) || filters.Items == true){
                ...
                allResults = [ ...allResults, ...Object.values(items)
                    ...
                    .map(item => ({
                        ...
                        id: item.name,
                        category: "Items",
                        imageUrl: `/warfarm-test/images/${item.name}.png`,
                    }))
                ];
            }
            ...
            if(!("Components" in filters) || filters.Components == true){
                ...
                allResults = [ ...allResults, ...Object.values(components)
                    ...
                    .map(component => ({
                        ...
                        id: component.id,
                        category: "Components",
                        imageUrl: `/warfarm-test/images/${component.fullName}.png`,
                    }))
                ];
            }
            ...
            if(!("Relics" in filters) || filters.Relics == true){
                ...
                allResults = [ ...allResults, ...Object.entries(relics)
                    ...
                    .map(([relicName, relic]) => ({
                        ...
                        id: relicName,
                        category: "Relics",
                        imageUrl: `/warfarm-test/images/${relicName.split(" ")[0].trim()}.png`,
                    }))
                ];
            }
            ...
            if(!("Missions" in filters) || filters.Missions == true){
                ...
                allResults = [ ...allResults, ...Object.values(missions)
                    ...
                    .map(mission => ({
                        ...
                        category: "Missions",
                        imageUrl: `/warfarm-test/images/${mission.planet}.png`,
                    }))
                ];
            }
    ...
    return (
        ...
        >
            ...
            <ContextMenuButton 
                ...
                headerContent={<img className="sized-content global-search-bar-filter-icon" src="/warfarm-test/icons/filter.svg" />}
            >
                {
                    (props) => (
