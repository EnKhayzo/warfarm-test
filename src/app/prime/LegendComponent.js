      ...
      <div className='sized-content v-flex flex-center' style={{ gap: '30px' }}>
        <div className="sized-content v-flex flex-center">
            ...
            <div className="sized-content v-flex">
              ...
              <span className="sized-content h-flex" style={{ whiteSpace: 'pre', alignItems: 'center' }}><img className="icon-default-filter" style={{ width: '20px', height: '20px' }} src={`${com.getBaseEnvPath().basePath}/icons/crafted.svg`}/> = Crafted Button, shows whether the current object is crafted, you can click it to toggle the crafted status (applies to items and components).</span>
