    ...
    <div className='sized-remaining v-flex flex-center' style={{ whiteSpace: 'pre', gap: '50px' }}>
      ...
      <div className='sized-remaining v-flex flex-center' style={{ whiteSpace: 'pre', gap: '30px' }}>
        ...
        <div className='sized-content h-flex flex-center' style={{ whiteSpace: 'pre', gap: '40px' }}>
          ...
          <Link href="https://www.youtube.com/@EnKhayzo"><img src={`${com.getBaseEnvPath().basePath}/icons/youtube.svg`} className='sized-content h-flex flex-center' style={{ width: '30px', height: '30px', opacity: '70%' }}/></Link>
          <Link href="https://x.com/EnKhayzo"><img src={`${com.getBaseEnvPath().basePath}/icons/twitterx.svg`} className='sized-content h-flex flex-center icon-default-filter' style={{ width: '30px', height: '30px', opacity: '70%' }}/></Link>
          <Link href="https://www.reddit.com/user/EnKhayzolo/"><img src={`${com.getBaseEnvPath().basePath}/icons/reddit.svg`} style={{ width: '30px', height: '30px', opacity: '70%' }}/></Link>
          <Link href="https://ko-fi.com/enkhayzo"><img src={`${com.getBaseEnvPath().basePath}/icons/kofi.svg`} style={{ width: '30px', height: '30px', opacity: '70%' }}/></Link>
          <Link href="https://www.patreon.com/bePatron?u=139879751"><img src={`${com.getBaseEnvPath().basePath}/icons/patreon.svg`} className='sized-content h-flex flex-center' style={{ filter: 'invert()', width: '30px', height: '30px', opacity: '70%' }}/></Link>
        </div>
      </div>
    </div>
  );
