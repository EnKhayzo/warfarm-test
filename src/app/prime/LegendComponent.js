      ...
      <div className="sized-content v-flex flex-center" style={{ gap: '50px' }}>
        ...
        <div className="sized-content v-flex flex-center">
          ...
          <div className="sized-content v-flex">
            <span className="sized-content h-flex" style={{ whiteSpace: 'pre' }}><img className="icon-gold-filter" style={{ width: '20px', height: '20px' }} src="/warfarm-test/icons/star_hollow_filled.svg"/> = Object that has been tracked, you can click on it to untrack/track.</span>
            <span className="sized-content h-flex" style={{ whiteSpace: 'pre' }}><img className="icon-default-filter" style={{ width: '20px', height: '20px' }} src="/warfarm-test/icons/success_hollow.svg"/> = You can click this icon to toggle the item as farmed automatically, it will set all related components to their respective required count.</span>
            <span className="sized-content h-flex" style={{ whiteSpace: 'pre' }}><img className="icon-partial-filter" style={{ width: '20px', height: '20px' }} src="/warfarm-test/icons/square.svg"/> = The object has been partially farmed, some parts/components are still missing. The blue fill square indicates how much of the object you have.</span>
            <span className="sized-content h-flex" style={{ whiteSpace: 'pre' }}><img className="icon-success-filter" style={{ width: '20px', height: '20px' }} src="/warfarm-test/icons/success.svg"/> = The object has been farmed: in the case of an item it means every component has been obtained. You can click this to toggle remove the farmed status of the object.</span>
            <span className="sized-content h-flex" style={{ whiteSpace: 'pre' }}><img className="icon-gold-filter" style={{ width: '20px', height: '20px' }} src="/warfarm-test/icons/resurgence.svg"/> = Prime Resurgence Object, can be an item, a component or a relic.</span>
          </div>
        </div>
        <div className="sized-content v-flex flex-center">
