...
export default function SellItemButton({ positionAbsolute=true, itemId }){
    ...
    const isSell = com.getUserDataSellItemValue(itemId) > 0;
                ...
                onClick={(ev) => { 
                    ...
                    com.toggleContextMenuUis({
                        ...
                        children: (props) => (
                            ...
                            >
                                <div className='sized-content h-flex flex-center' style={{ whiteSpace: 'pre' }}>Sell {rawObj.fullName ?? rawObj.name}{ rawObj.category !== "items" ? null: '\'s components' }</div>
                                <div 
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div 
                                                            ...
                                                            className={`sized-remaining item-page-component-container item-check-parent tracker-item-parent v-flex flex-center${` ${component.rarity}` ?? ''}`}
                                                            style={{
                                                                gap: '5px',
                                                                position: 'relative',
                                                                cursor: 'pointer',
                                                        ...
                                                        >
                                                            <div className='sized-content h-flex flex-center'><img src={`${com.getBaseEnvPath().basePath}/images/${component.fullName}.png`}/></div>
